...
class dBOperation:
    """
      ...
      """
    def __init__(self):
        self.path = 'loan_default/Training_Database/'
        self.badFilePath = "loan_default/Training_Raw_files_validated/Bad_Raw"
        self.goodFilePath = "loan_default/Training_Raw_files_validated/Good_Raw"
    ...
    def insertIntoCollectionGoodData(self,DatabaseName):
        ...
        """
        try:
            client = pymongo.MongoClient("mongodb+srv://abe:abe@cluster0.ifiok.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
            file = open("loan_default/Training_Logs/DataBaseConnectionLog.txt", 'a+')
        ...
        try:
            ...
            log_file = open("loan_default/Training_Logs/DbCollectionDataInsertionLog.txt", 'a+')
    ...
    def selectingDatafromtableintocsv(self,Database):
        ...
        """
                               ...
                               Description: This method exports the data in the database as a CSV file. in a given location.
                                            above created .
                               Output: None
                               On Failure: Raise Exception
        ...
        self.fileFromDb = 'loan_default/Training_FileFromDB/'
        #self.fileName = 'InputFile.csv'
        log_file = open("loan_default/Training_Logs/ExportToCsv.txt", 'a+')
        try:
            # Make the CSV output directory
            if not os.path.isdir(self.fileFromDb):
                os.makedirs(self.fileFromDb)

            client = pymongo.MongoClient("mongodb+srv://abe:abe@cluster0.ifiok.mongodb.net/myFirstDatabase?retryWrites=true&w=majority") #To be changed as per requirement
            db = client[Database]
